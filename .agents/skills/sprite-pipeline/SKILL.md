...
2. Build a larger transparent reference canvas around that frame.
   - Use `../game-studio/scripts/build_sprite_edit_canvas.py`.
...
4. Normalize the result into fixed-size game frames.
   - Use `../game-studio/scripts/normalize_sprite_strip.py`.
...
6. Render a preview sheet and inspect the animation in-engine before approving it.
   - Use `../game-studio/scripts/render_sprite_preview_sheet.py`.
...
- Detailed workflow: `../game-studio/references/sprite-pipeline.md`
